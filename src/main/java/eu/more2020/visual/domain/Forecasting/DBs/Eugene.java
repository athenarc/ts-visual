...
public class Eugene {
    ...
    public Point toPoint() {
        return Point.measurement("eugene")
    ...
    public Eugene(Instant timestamp, double irradiance, double mod_temp, double shortCircuitCurrent,
    ...
    public String toString() {
        return "Eugene [timestamp=" + timestamp + ", irradiance=" + irradiance + ", mod_temp="
